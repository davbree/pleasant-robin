...
sections:
  - type: HeroSection
    ...
    badge:
      label: New Website!!!..
    title: 'This Is A Big!!r!!!'
    text: |-
      Aenean eros ipsum, interdusdsquis dignissim non, sollicitudin vitae nisl. Aenean vel aliquetdss elidddsdst, at blandit ipsum. Sed eleifeddddnd felis sit amet erat molestie, hendrerit malesuada justo ultrices. Nunc volutpat at erat vitae interdum. Ut nec massa eget lorem blandit condimentum et at risus.///
    actions:
      - type: Button
        label: Get Started
